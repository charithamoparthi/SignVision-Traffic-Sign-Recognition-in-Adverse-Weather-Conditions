...
YOLOv8 detects candidate traffic sign regions quickly
Faster R-CNN refines detections for better localization
NMS fusion removes overlapping boxes and finalizes predictions
Voice module converts detected sign labels into spoken alerts
📂 Dataset
